...
type PageInfoItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PageLimit  int64 `protobuf:"varint,1,opt,name=page_limit,json=pageLimit,proto3" json:"page_limit,omitempty"`
...
func (x *PageInfoItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PageInfoItem) ProtoMessage() {}

func (x *PageInfoItem) ProtoReflect() protoreflect.Message {
	mi := &file_common_types_proto_msgTypes[0]
...
// Deprecated: Use PageInfoItem.ProtoReflect.Descriptor instead.
func (*PageInfoItem) Descriptor() ([]byte, []int) {
	return file_common_types_proto_rawDescGZIP(), []int{0}
}

func (x *PageInfoItem) GetPageLimit() int64 {
	if x != nil {
		return x.PageLimit
	}
	return 0
...
func (x *PageInfoItem) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *PageInfoItem) GetPageNumber() int64 {
	if x != nil {
		return x.PageNumber
	}
	return 0
...
func (x *PageInfoItem) GetTotalItems() int64 {
	if x != nil {
		return x.TotalItems
	}
	return 0
...
var file_common_types_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65,
	0x73, 0x22, 0x8c, 0x01, 0x0a, 0x0c, 0x50, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x74,
	0x65, 0x6d, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x4c, 0x69, 0x6d, 0x69,
	...
	0x42, 0x24, 0x5a, 0x22, 0x2e, 0x2f, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	0x73, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x70, 0x6f, 0x69, 0x6e,
	0x74, 0x73, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_common_types_proto_goTypes = []interface{}{
	(*PageInfoItem)(nil), // 0: CommonTypes.PageInfoItem
}
